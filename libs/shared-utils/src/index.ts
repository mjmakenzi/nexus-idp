...
export * from './revoked-token/revoked-token.module';
...
export * from './device-detection/device-detection.module';
export * from './device-detection/device-detection.service';
